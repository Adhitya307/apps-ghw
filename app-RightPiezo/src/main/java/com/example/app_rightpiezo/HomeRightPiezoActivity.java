...
public class HomeRightPiezoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(() -> {
            Log.d(TAG, "Aplikasi Piezometer Sandaran Bendungan Kanan siap digunakan");
    ...
    private void setupClickListeners() {
        ...
        // History Button (dikomentari sementara)
        /**
    ...
    /**
     ...
     try {
     Intent intent = new Intent(this, HistoryRightPiezo.class);
     startActivity(intent);
     overridePendingTransition(android.R.anim.fade_in, android.R.anim.fade_out);
     } catch (Exception e) {
