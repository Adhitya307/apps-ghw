...
public class InputdataElv600 extends AppCompatActivity {
    ...
    private void showCalculationResultDialogELV600(String tanggal, double hv1, double hv2, double hv3, double hv4, double hv5) {
        runOnUiThread(() -> {
            try {
                ...
                // HV1
                double amanH1 = -44.29, peringatanH1 = -51.11, bahayaH1 = -60.40 ;
                // HV2
                double amanH2 = -39.75, peringatanH2 = -45.86, bahayaH2 = -54.20 ;
                // HV3
                double amanH3 = -40.63, peringatanH3 = -46.88, bahayaH3 = -55.40;
                // HV4
                double amanH4 = -24.86, peringatanH4 = -28.68, bahayaH4 = -33.90 ;
                // HV5
                double amanH5 = -11.22, peringatanH5 = -12.95, bahayaH5 = -15.30 ;
                ...
                tvStatusH1.setText("KONDISI: " + analyzeStatusELV600(pergerakanH1, peringatanH1, bahayaH1));
                ...
                tvStatusH2.setText("KONDISI: " + analyzeStatusELV600(pergerakanH2, peringatanH2, bahayaH2));
                ...
                tvStatusH3.setText("KONDISI: " + analyzeStatusELV600(pergerakanH3, peringatanH3, bahayaH3));
                ...
                tvStatusH4.setText("KONDISI: " + analyzeStatusELV600(pergerakanH4, peringatanH4, bahayaH4));
                ...
                tvStatusH5.setText("KONDISI: " + analyzeStatusELV600(pergerakanH5, peringatanH5, bahayaH5));
    ...
    // ✅ FIXED: Method untuk menganalisis status ELV600
    private String analyzeStatusELV600(double pergerakan, double peringatan, double bahaya) {
        // Logika:
        // 1. AMAN: pergerakan ≥ (peringatan + 0.01)
        //    Contoh: ≥ -51.10 (untuk HV1)
        // 2. PERINGATAN: pergerakan antara peringatan dan bahaya
        //    Contoh: -51.11 sampai -60.39 (untuk HV1)
        // 3. BAHAYA: pergerakan ≤ bahaya
        //    Contoh: ≤ -60.40 (untuk HV1)
