...
public class Initial600Model {
    private int id_initial_reading;
    ...
    // Getters and Setters
    public int getId_initial_reading() { return id_initial_reading; }
    public void setId_initial_reading(int id_initial_reading) { this.id_initial_reading = id_initial_reading; }
    ...
    public Double getHv_4() { return hv_4; }
    public void setHv_4(Double hv_4) { this.hv_4 = hv_4; }
    public Double getHv_5() { return hv_5; }
    public void setHv_5(Double hv_5) { this.hv_5 = hv_5; }
