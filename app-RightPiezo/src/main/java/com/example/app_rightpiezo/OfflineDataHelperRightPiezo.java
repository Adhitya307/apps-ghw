...
public class OfflineDataHelperRightPiezo extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "rightpiezo_offline.db";
    ...
    public OfflineDataHelperRightPiezo(Context context) {
     ...
     */
    public boolean insertDataRightPiezo(String tableType, String tempId, String jsonData) {
     ...
     */
    public boolean insertDataRightPiezoWithMode(String tableType, String tempId, String jsonData,
     ...
     */
    public List<Map<String, String>> getUnsyncedDataRightPiezo(String tableType) {
     ...
     */
    public Map<String, String> getRightPiezoData(int pengukuranId, String lokasi) {
        Map<String, String> data = new HashMap<>();
     ...
     */
    public List<Map<String, String>> getPengukuranMasterRightPiezo() {
        List<Map<String, String>> dataList = new ArrayList<>();
     ...
     */
    public void deleteByTempIdRightPiezo(String tableType, String tempId) {
        String tableName = tableType.equals("pengukuran") ? TABLE_PENGUKURAN : TABLE_DATA;
        SQLiteDatabase db = this.getWritableDatabase();
     ...
     */
    public boolean hasUnsyncedDataRightPiezo() {
        SQLiteDatabase db = this.getReadableDatabase();
     ...
     */
    public int getOfflineDataCountRightPiezo() {
        SQLiteDatabase db = this.getReadableDatabase();
